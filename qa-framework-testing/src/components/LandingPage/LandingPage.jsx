            ...
            <div>
                ...
                <div className="container">
                    ...
                    <div className="pages-container">
                        ...
                        <Link to='/guidelines-1.4.2'>Guidelines 1.4.2</Link>
                        <Link to='/guidelines-2.4.2'>Guidelines 2.4.2</Link>
                        <Link to='/guidelines-2.4.6'>Guidelines 2.4.6</Link>
                        <Link to='/guidelines-3.2.1'>Guidelines 3.2.1</Link>
                    ...
                    <div className="pages-container">
                        ...
                        <Link to='/resolved-guidelines-1.4.2'>Resolved Guidelines 1.4.2</Link>
                        <Link to='/resolved-guidelines-2.4.2'>Resolved Guidelines 2.4.2</Link>
                        <Link to='/resolved-guidelines-2.4.6'>Resolved Guidelines 2.4.6</Link>
                        <Link to='/resolved-guidelines-3.2.1'>Resolved Guidelines 3.2.1</Link>
